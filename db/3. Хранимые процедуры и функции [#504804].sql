...
create or replace procedure insert_data(i_name varchar)
language 'plpgsql'
as $$
    BEGIN
...
alter procedure insert_data(i_name varchar) rename to delete_data;

call delete_data('product_1');
